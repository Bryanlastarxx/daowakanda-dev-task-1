...
// Account address
// 5PM6ITDNVXBVWBYP2KG6OSSC6FSKYVZSMTWACOWUI2SVI76ZO4GHRB5TTU
...
async function loadAccount() {
  ...
  const account = client.account.fromMnemonic('exile mammal setup submit sound parade utility spend sun mother deer casino clog chalk dose claw worry liberty piece ceiling demand pattern fancy absent hold');
